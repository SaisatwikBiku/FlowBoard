...
export default function Whiteboard({ tool, color, lang, brushSize }) {
  ...
  const getCursor = () => {
    switch (tool) {
      case "pen":
        return "url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 20 20\"><circle cx=\"10\" cy=\"10\" r=\"3\" fill=\"black\"/></svg>') 10 10, auto";
      case "eraser":
        return "url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 20 20\"><rect x=\"4\" y=\"4\" width=\"12\" height=\"12\" fill=\"black\" stroke=\"black\"/></svg>') 10 10, auto";
      case "sticky":
